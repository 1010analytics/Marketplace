...
//       <CssBaseline />
//       {!hideNavbarRoutes.includes(location.pathname) && (
//         <Navbar cartCount={cartItems.reduce((count, item) => count + item.quantity, 0)} userName={userName} />
//       )}
//       <Routes>
//         <Route path="/home" element={<Hero setCartCount={handleAddToCart} />} />
//         <Route path="/products" element={<Products />} />
//         <Route path="/categories" element={<Categories setCartCount={handleAddToCart} />} />
//         <Route path="/about" element={<About />} />
//         <Route path="/contact" element={<Contact />} />
//         <Route path="/login" element={<Login setUserName={setUserName} />} />
//         <Route path="/signup" element={<Register setUserName={setUserName} />} />
